...
func TestMarshalUnmarshalIndexTerm(t *testing.T) {
	v := IndexTerm{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgIndexTerm(b *testing.B) {
	v := IndexTerm{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgIndexTerm(b *testing.B) {
	v := IndexTerm{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalIndexTerm(b *testing.B) {
	v := IndexTerm{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeIndexTerm(t *testing.T) {
	v := IndexTerm{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkEncodeIndexTerm(b *testing.B) {
	v := IndexTerm{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeIndexTerm(b *testing.B) {
	v := IndexTerm{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func TestMarshalUnmarshalLeaderRedirect(t *testing.T) {
	v := LeaderRedirect{}
	bts, err := v.MarshalMsg(nil)
	if err != nil {
		t.Fatal(err)
...
func BenchmarkMarshalMsgLeaderRedirect(b *testing.B) {
	v := LeaderRedirect{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgLeaderRedirect(b *testing.B) {
	v := LeaderRedirect{}
	bts := make([]byte, 0, v.Msgsize())
	bts, _ = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalLeaderRedirect(b *testing.B) {
	v := LeaderRedirect{}
	bts, _ := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
...
func TestEncodeDecodeLeaderRedirect(t *testing.T) {
	v := LeaderRedirect{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
...
func BenchmarkEncodeLeaderRedirect(b *testing.B) {
	v := LeaderRedirect{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
...
func BenchmarkDecodeLeaderRedirect(b *testing.B) {
	v := LeaderRedirect{}
	var buf bytes.Buffer
	msgp.Encode(&buf, &v)
	b.SetBytes(int64(buf.Len()))
