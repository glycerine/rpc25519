...
func (z *SenderPlan) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if !empty[2] {
		...
		if z.SenderChunksNoSlice == nil {
			...
			o, err = z.SenderChunksNoSlice.MarshalMsg(o) // not is.iface, gen/marshal.go:243
			if err != nil {
				return
			}
		}
...
doneWithStruct65zgensym_9db0ba711f6a3e5a_66:
	...
	for encodedFieldsLeft65zgensym_9db0ba711f6a3e5a_66 > 0 || missingFieldsLeft65zgensym_9db0ba711f6a3e5a_66 > 0 {
		...
		case "SenderChunksNoSlice_zid02_ptr":
			...
			// unmarshalGen.gPtr(): we have a BaseElem: &gen.BaseElem{Common:gen.Common{vname:"z.SenderChunksNoSlice", alias:"Chunks", hmp:gen.HasMethodPrefix(nil), zid:0}, ShimToBase:"", ShimFromBase:"", Value:0x16, Convert:false, mustinline:false, needsref:false, isIface:false, isInIfaceSlice:false}
