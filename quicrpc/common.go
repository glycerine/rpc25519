...
func receiveMessage(conn quic.Stream, timeout *time.Duration) ([]byte, error) {
...
// nil or 0 timeout means no timeout.
func sendMessage(command int64, conn quic.Stream, msg []byte, timeout *time.Duration) error {
...
func readFull(conn quic.Stream, buf []byte, timeout *time.Duration) error {
...
func writeFull(conn quic.Stream, buf []byte, timeout *time.Duration) error {
