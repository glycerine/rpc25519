...
doneWithStruct4zgensym_28874796354aa7f3_5:
	...
	for encodedFieldsLeft4zgensym_28874796354aa7f3_5 > 0 || missingFieldsLeft4zgensym_28874796354aa7f3_5 > 0 {
		...
		case "ProxyType_zid13_int":
			found4zgensym_28874796354aa7f3_5[13] = true
			z.ProxyType, err = dc.ReadInt()
			if err != nil {
				return
			}
		default:
...
func (z *HDR) fieldsNotEmpty(isempty []bool) uint32 {
	...
	isempty[13] = (z.ProxyType == 0) // number, omitempty
	if isempty[13] {
		fieldsInUse--
	}
...
func (z *HDR) EncodeMsg(en *msgp.Writer) (err error) {
	...
	if !empty_zgensym_28874796354aa7f3_8[13] {
		// write "ProxyType_zid13_int"
		err = en.Append(0xb3, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x54, 0x79, 0x70, 0x65, 0x5f, 0x7a, 0x69, 0x64, 0x31, 0x33, 0x5f, 0x69, 0x6e, 0x74)
		if err != nil {
			return err
		}
		err = en.WriteInt(z.ProxyType)
		if err != nil {
			return
		}
	}
...
func (z *HDR) MarshalMsg(b []byte) (o []byte, err error) {
	...
	if !empty[13] {
		// string "ProxyType_zid13_int"
		o = append(o, 0xb3, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x54, 0x79, 0x70, 0x65, 0x5f, 0x7a, 0x69, 0x64, 0x31, 0x33, 0x5f, 0x69, 0x6e, 0x74)
		o = msgp.AppendInt(o, z.ProxyType)
	}
...
doneWithStruct10zgensym_28874796354aa7f3_11:
	...
	for encodedFieldsLeft10zgensym_28874796354aa7f3_11 > 0 || missingFieldsLeft10zgensym_28874796354aa7f3_11 > 0 {
		...
		case "ProxyType_zid13_int":
			...
			z.ProxyType, bts, err = nbs.ReadIntBytes(bts)
