...
const (
	...
	CallPeerTrafficWithServiceFallback CallType = 121
)
...
func (ct CallType) String() string {
	...
	case CallPeerTrafficWithServiceFallback:
		return "CallPeerTrafficWithServiceFallback"
...
func (msg *Message) String() string {
	return fmt.Sprintf("&Message{HDR:%v, LocalErr:'%v',\n len %v JobSerz\n JobErrs: '%v'}", msg.HDR.String(), msg.LocalErr, len(msg.JobSerz), msg.JobErrs)
}
